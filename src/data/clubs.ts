...
export const clubs: Club[] = [
  {
    ...
    position: "Khu vực ngoài trời - Vườn sinh thái",
  ...
  },
  {
    ...
    description:
      "F-SKILL là nơi các bạn có thể học hỏi, thực hành và phát triển kỹ năng IT. Luôn cập nhật xu hướng mới và chia sẻ kiến thức lập trình.",
