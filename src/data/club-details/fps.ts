...
export const fpsDetail: ClubDetail = makeDetail({
   id: 101,
   ...
   achievements: [
      {
         title: "Giải đấu game định kỳ",
         description: "Tổ chức thành công các giải đấu game hàng tháng"
      },
      {
         title: "Workshop kỹ năng",
         description: "Đào tạo kỹ năng game và teamwork cho thành viên"
      }
   ],
   activities: [
      "Tổ chức giải đấu game định kỳ",
   ...
   teamStructure: [
      { role: "Chủ nhiệm", count: "1" },
      { role: "Phó chủ nhiệm", count: "2" },
      { role: "Thành viên", count: "20+" }
   ],
   goals2024: [
      "Mở rộng cộng đồng game thủ",
      "Tổ chức giải đấu esport cấp trường",
      "Đào tạo kỹ năng game chuyên nghiệp",
      "Xây dựng môi trường gaming lành mạnh"
   ],
   contactInfo: {
      email: "fps@fpt.edu.vn",
      hotline: "0123 456 789",
      office: "Phòng Game – Tầng 1",
      workingHours: "Thứ 2 - Thứ 6: 8:00 - 17:00"
   }
})

export default fpsDetail
