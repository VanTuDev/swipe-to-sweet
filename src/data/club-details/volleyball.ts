...
export const volleyballDetail: ClubDetail = makeDetail({
   id: 14,
   name: "🏐 Fvolleyball 🏐",
   ...
   benefits: [
      "💪 Cơ hội được huấn luyện kỹ thuật bóng chuyền từ cơ bản đến nâng cao",
      "⚡ Thể lực tăng vọt, phản xạ nhanh hơn, tinh thần thép hơn mỗi ngày",
      "🎉 Giải tỏa áp lực học hành bằng không khí năng động, vui tươi",
      "🤝 Gắn kết bạn bè, mở rộng mối quan hệ và tạo kỷ niệm đáng nhớ",
      "🌈 Tham gia hoạt động ngoại khóa, team building và giải đấu",
   ],
   googleForm: "",
})
