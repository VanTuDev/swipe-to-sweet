...
export const fdnEventsDetail: ClubDetail = makeDetail({
   id: 9,
   name: "FDN-Events",
   ...
   description:
      "Mục tiêu hoạt động:\n Tổ chức sự kiện, hỗ trợ các hoạt động truyền thông, thiết kế và hiện thực hóa các ý tưởng sáng tạo dành cho sinh viên.\n\nThành viên:\n Hiện có hơn 100 thành viên năng động, kỹ năng tốt, luôn sẵn sàng phối hợp tổ chức sự kiện từ A đến Z.\n\nThâm niên:\n 7 năm hoạt động chính thức, từng tham gia tổ chức hơn 20 sự kiện lớn nhỏ như Lễ Tôn Vinh, Sự kiện tôn vinh phái đẹp, Tri ân thầy cô, Tri ân cựu học sinh, FClub,..v..v..",
