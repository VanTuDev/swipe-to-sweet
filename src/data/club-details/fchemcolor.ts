...
export const fchemcolorDetail: ClubDetail = makeDetail({
   id: 105,
   name: "🧪 FChemColor",
   ...
   emoji: "🧪",
   shortIntro:
      "Bạn yêu thích khám phá những phản ứng kỳ diệu, muốn tìm hiểu bí mật phía sau những hiện tượng quen thuộc trong cuộc sống, hay đơn giản là thích \"làm thí nghiệm cho vui\"? Hãy đến với Câu lạc bộ Hóa học – nơi biến những công thức khô khan thành những trải nghiệm đầy sắc màu!",
   description:
   ...
   contactInfo: {
      email: "",
      hotline: "",
      office: "Phòng thí nghiệm 115 Hóa học",
      workingHours: "Chiều thứ Sáu, 2 tuần/lần",
   },
})

export default fchemcolorDetail
