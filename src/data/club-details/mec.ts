...
export const mecDetail: ClubDetail = makeDetail({
   id: 102,
   ...
   emoji: "🌐",
   shortIntro:
      "MEC là nơi bạn bắt đầu chuyến hành trình vòng quanh thế giới – không cần visa, chỉ cần bạn không ngần ngại sử dụng tiếng Anh như một công cụ kết nối với mọi người!",
   description:
